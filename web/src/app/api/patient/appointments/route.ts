...
export async function proxyAppointments(request: Request, path = "") {
  ...
  const response = await fetch(new URL(`/api/appointments${path}`, apiUrl), {
...
export async function GET(request: Request) {
  return proxyAppointments(request);
}
