...
export default function ProviderPage() {
  ...
  return ready ? <main className={styles.page}><ProviderAppointmentSchedule /><ProviderScheduleSettings /><section><h1>Patient activity audit log</h1><p>Events touching your patients, shown as security references only.</p><AuditLogViewer /></section></main> : <main aria-busy="true">Checking your secure session…</main>;
}
